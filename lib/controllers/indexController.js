...
exports.testController = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const cachedData = yield app_1.client.get("private_jets");
    console.log({ cachedData: "cachedData" });
    if (cachedData) {
        console.log("using cached data");
        response.setSuccess(200, "Using cached data", JSON.parse(cachedData));
        return response.send(res);
    }
    const data = yield (0, API_1.fetchData)();
    // client.set()
    app_1.client.setEx("private_jets", EXPIRATION_TIME, JSON.stringify(data));
